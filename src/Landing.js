...
export default function landing() {
    return (
        ...
        <Link to="/Products"><a href="" className="Logo"><img src={logo} className="Logo-hover" style={{display: 'flex',  justifyContent:'center', alignItems:'center', height: '10vh', onLoad: 'fadeIn'}} /></a></Link>
        </div> 
    )
}
